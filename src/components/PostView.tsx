...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@/components/ui/dialog"; // ✅ add DialogTitle
...
type Props = {
  id: string;
  post: PostWithExtras;
  asModal?: boolean; // allow route page to force modal state
};

function PostView({ id, post, asModal = false }: Props) {
  const pathname = usePathname();
  const isPostModal = asModal || pathname === `/dashboard/p/${id}`;
